...
export default function NoticesPage() {
    ...
    return (_jsxs("div", { className: "mx-auto flex w-full max-w-4xl flex-col gap-6", children: [_jsxs("div", { className: "overflow-hidden rounded-[1.5rem] border border-emerald-200 bg-gradient-to-br from-emerald-950 via-emerald-900 to-green-700 p-6 text-white shadow-[0_24px_60px_-30px_rgba(5,150,105,0.55)]", children: [_jsx("p", { className: "text-sm font-semibold uppercase tracking-[0.3em] text-emerald-100", children: "Community Notices & Alerts" }), _jsx("h1", { className: "mt-2 text-2xl font-black", children: "This channel is for important updates" }), _jsx("p", { className: "mt-2 max-w-2xl text-sm leading-7 text-emerald-50", children: !roleResolved
                        ...
                        return (_jsxs("article", { className: `page-card p-5 ${isMayyat ? "border-2 border-slate-800 bg-slate-50 shadow-[0_12px_35px_rgba(15,23,42,0.12)]" : ""}`, children: [_jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [isMayyat ? (_jsx("span", { className: "rounded-full bg-slate-900 px-3 py-1 text-xs font-semibold uppercase tracking-[0.16em] text-white", children: "Mayyat Notification" })) : null, _jsx("h3", { className: `text-lg font-semibold ${isMayyat ? "text-slate-950" : "text-slate-800"}`, children: notice.title }), notice.pinned ? _jsx("span", { className: "rounded-full bg-amber-100 px-2.5 py-1 text-xs font-semibold text-amber-700", children: "Pinned" }) : null] }), isMayyat && mayyatRows.length > 0 ? (_jsx("dl", { className: "mt-4 grid gap-3 sm:grid-cols-2", children: mayyatRows.map(([label, value]) => (_jsxs("div", { className: "rounded-lg border border-slate-200 bg-white px-3 py-2", children: [_jsx("dt", { className: "text-xs font-semibold uppercase tracking-[0.12em] text-slate-500", children: label }), _jsx("dd", { className: "mt-1 text-sm font-semibold text-slate-900", children: value })] }, label))) })) : (_jsx("p", { className: `mt-2 whitespace-pre-line text-sm leading-6 ${isMayyat ? "font-medium text-slate-900" : "text-slate-700"}`, children: notice.body }))] }), _jsxs("div", { className: "text-sm text-slate-500", children: [_jsx("p", { children: notice.author }), _jsx("p", { children: new Date(notice.createdAt).toLocaleString() })] })] }), _jsxs("div", { className: "mt-5 flex flex-wrap items-center gap-2 border-t border-slate-200 pt-3", children: [!isMayyat ? (_jsxs(_Fragment, { children: [reactionOptions.map((reaction) => (_jsxs("button", { type: "button", onClick: () => handleReact(notice.id, reaction), className: `inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-sm font-semibold transition ${selectedReaction === reaction
                                                        ...
                                                        ? "border-slate-800 bg-slate-900 text-white"
                                                        : "border-slate-200 bg-white text-slate-600 hover:border-slate-400"}`, children: "Mayyat notification" })] }), editNoticeType === "mayyat" ? (_jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [_jsx("input", { value: editMayyatDetails.deceasedName, onChange: (event) => updateEditMayyatDetails("deceasedName", event.target.value), placeholder: "Marhoom/marhooma ka naam", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.relationName, onChange: (event) => updateEditMayyatDetails("relationName", event.target.value), placeholder: "Walid/shohar ya family reference", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.age, onChange: (event) => updateEditMayyatDetails("age", event.target.value), placeholder: "Age", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.jamaat, onChange: (event) => updateEditMayyatDetails("jamaat", event.target.value), placeholder: "Jamaat / area", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.passedAwayAt, onChange: (event) => updateEditMayyatDetails("passedAwayAt", event.target.value), placeholder: "Inteqal date/time", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.funeralPrayerAt, onChange: (event) => updateEditMayyatDetails("funeralPrayerAt", event.target.value), placeholder: "Namaz-e-janaza date/time", className: "form-input px-3 py-2" }), _jsx("input", { value: editMayyatDetails.funeralPrayerPlace, onChange: (event) => updateEditMayyatDetails("funeralPrayerPlace", event.target.value), placeholder: "Janaza place / masjid", className: "form-input px-3 py-2 sm:col-span-2" }), _jsx("input", { value: editMayyatDetails.burialPlace, onChange: (event) => updateEditMayyatDetails("burialPlace", event.target.value), placeholder: "Tadfeen / qabrastan", className: "form-input px-3 py-2 sm:col-span-2" }), _jsx("textarea", { value: editMayyatDetails.notes, onChange: (event) => updateEditMayyatDetails("notes", event.target.value), rows: 3, placeholder: "Extra notes / dua request", className: "form-input px-3 py-2 sm:col-span-2" })] })) : (_jsxs(_Fragment, { children: [_jsx("input", { value: editTitle, onChange: (event) => setEditTitle(event.target.value), className: "form-input px-3 py-2", placeholder: "Edit title" }), _jsx("textarea", { value: editBody, onChange: (event) => setEditBody(event.target.value), rows: 3, className: "form-input px-3 py-2", placeholder: "Edit message" })] })), _jsxs("label", { className: "flex items-center gap-2 text-sm text-gray-600", children: [_jsx("input", { type: "checkbox", checked: editPinned, onChange: () => setEditPinned((current) => !current) }), "Pin this notice"] }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [_jsx("button", { type: "button", onClick: () => saveEdit(notice.id), className: "btn-primary rounded-lg px-3 py-2 text-sm font-semibold", children: "Save" }), _jsx("button", { type: "button", onClick: cancelEdit, className: "btn-secondary rounded-lg px-3 py-2 text-sm font-semibold", children: "Cancel" })] })] })) : null] }, notice.id));
                    })] })] }));
}
