...
export default function PeopleProfile() {
    ...
    const profileCompletion = useMemo(() => {
        const fields = ["fullName", "email", "mobile", "dob", "cnic"];
