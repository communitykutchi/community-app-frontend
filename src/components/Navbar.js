...
const t = (key) => navbarTranslations[key] || key;
...
export default function Navbar() {
    ...
    useEffect(() => {
        ...
        const fetchUnreadChatCount = () => {
            API.get('/friends/unread-chat-count')
                .then((response) => {
